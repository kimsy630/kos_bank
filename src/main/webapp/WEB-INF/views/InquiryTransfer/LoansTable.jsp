                ...
                <table class="table-custom table-custom-secondary table-custom-hovered" id="acc_table">
                    ...
                    <tr>
                      ...
                      <td> 
                      	...
                      	<div class="btn btn-primary" style="padding:10px; width:80px; height:40px; font-size:12px; text-align:center; background-color: #435ebe; color:#fff; display:inline;" onclick="location.href='LoanPrincipalCheck.do'">원금상환</div>
