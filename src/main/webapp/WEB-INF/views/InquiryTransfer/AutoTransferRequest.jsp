                ...
                <table class="table-custom table-custom-bordered" id="acc_table">
                  <thead>
                    <tr>
                      <th >약정구분</th>
                      	<td colspan="4">
                      		<input type="radio" name="Auto_check" id="AutoTransferAdd"> 약정
                      		<input type="radio" name="Auto_check" id="AutoTransferModify"> 정정
                      		<input type="radio" name="Auto_check" id="AutoTransferDelete"> 해지
                     	 </td>
                    </tr>
                  </thead>
                    <tr>
