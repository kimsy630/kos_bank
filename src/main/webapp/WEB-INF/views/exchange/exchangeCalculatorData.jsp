...
<script type="text/javascript">
	...
	<table class="table-custom table-custom-secondary table-custom-hovered">
		<tr>
			<th>환전기준</th>
			<td><input type="radio" name="currency" value="buy" id="won"
				checked> <label for="won">원화기준</label> <input type="radio"
				name="currency" value="sell" id="currency"> <label
				for="currency">외화기준</label></td>
		</tr>
		<tr>
		...
		<tr>
			<td colspan="2" style="text-align: center;"><input type="button"
				value="계산하기" class="button button-sm button-primary"
