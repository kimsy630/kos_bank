			                    		...
			                    		<c:forEach var="list" items="${list}">
						                	<tr>
						                    	<td>${list.d_name}</td>
						                      	...
						                      	<td> 
						                      		<div class="button button-round" style= "padding:10px 20px; width:60px; height:40px; font-size:15px; text-align:center; background-color: #435ebe; color:#fff; display:inline;" onclick="location.href='LoanAccountDetail.cc?d_name=${list.d_name}'">조회</div>
						                      	</td>
						                    </tr>
						                </c:forEach>
			                  		</tbody>
