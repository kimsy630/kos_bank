  	...
  	<body>        	
        ...
        <div class="row justify-content-lg-center">
			<a class="button button-round button-primary" 
				href="LoanPrincipalPay.cc?d_Key=${vo.d_Key}&account=${vo.account}&d_balance=${vo.d_balance}&redemption=${redemption}&d_tran=${vo.d_tran}&d_ERC=${vo.d_ERC}&d_auto_account=${vo.d_auto_account}" 
