...
public String toString() {
	return "LoansVO [d_Key=" + d_Key + ", d_name=" + d_name + ", account=" + account + ", d_state=" + d_state
			+ ", d_start_date=" + d_start_date + ", d_end_date=" + d_end_date + ", d_month=" + d_month + ", d_repay="
			+ d_repay + ", d_rate=" + d_rate + ", d_amount=" + d_amount + ", d_balance=" + d_balance
			+ ", d_balance_rate=" + d_balance_rate + ", d_loan_balance=" + d_loan_balance + ", d_loan_rate="
			+ d_loan_rate + ", d_tran=" + d_tran + ", d_tran_rate=" + d_tran_rate + ", d_next_rate=" + d_next_rate
			+ ", d_ERC=" + d_ERC + "]";
}
